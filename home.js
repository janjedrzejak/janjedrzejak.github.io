(() => {
  ...
  "education.heading": "WYKSZTAŁCENIE",
  "education.status": "STUDIA FORMALNE / UKOŃCZONE",
  "education.master.title": "Studia magisterskie — informatyka",
  "education.master.school": "Społeczna Akademia Nauk · Łódź, Polska",
  "education.master.specialization": "Specjalizacja: grafika komputerowa i technologie internetowe",
  "education.engineer.title": "Studia inżynierskie — informatyka",
  "education.engineer.school": "Społeczna Akademia Nauk · Ostrów Wielkopolski, Polska",
  "education.engineer.specialization": "Specjalizacja: wizualizacja i systemy zarządzania informacją",
  "credentials.selected": "WYBRANE CERTYFIKATY",
  "credentials.active": "CIĄGŁY ROZWÓJ / AKTYWNY",
  "credentials.n8n.type": "AUTOMATYZACJA / AI",
  "credentials.n8n.issuer": "n8n Academy · wrz 2026",
  "credentials.sixSigma.type": "DOSKONALENIE PROCESÓW",
  "credentials.sixSigma.issuer": "Scrum Study · lis 2025",
  "credentials.smc.type": "PRZYWÓDZTWO AGILE",
  "credentials.smc.issuer": "SCRUMstudy · lip 2024",
  "credentials.agile.type": "PODSTAWY AGILE",
  "credentials.agile.issuer": "IBM SkillsBuild · gru 2025",
  "credentials.pmi.type": "ZARZĄDZANIE PROJEKTAMI / AI",
  "credentials.pmi.issuer": "Project Management Institute · lip 2026",
  "credentials.verify": "Zweryfikuj certyfikat <span aria-hidden=\"true\">↗</span>",
  "credentials.certificate": "Zobacz certyfikat <span aria-hidden=\"true\">↗</span>",
  "credentials.badge": "Zobacz zweryfikowaną odznakę <span aria-hidden=\"true\">↗</span>",
  "credentials.all": "Zobacz moje odznaki w Credly <span aria-hidden=\"true\">↗</span>",
