(() => {
  ...
  // Language is resolved at build time. The language selector is a real link,
  // so crawlers and visitors without JavaScript receive the same document.
  const currentLanguage = doc.lang === "pl" ? "pl" : "en";
  const menuLabel = document.querySelector("[data-menu-label]");
  const interfaceLabels = {
    en: { openMenu: "Open menu", closeMenu: "Close menu" },
    pl: { openMenu: "Otwórz menu", closeMenu: "Zamknij menu" }
  };
